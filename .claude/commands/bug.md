...
- `cd docker/app/server && npm run test:run` - Run server tests to validate the bug is fixed with zero regressions
- `cd docker/app/client && npm run test:unit` - Run client tests to validate the bug is fixed with zero regressions
- `cd docker/app/client && npm run test:e2e` - Run end-to-end tests with Playwright if required to validate the bug is fixed with zero regressions
