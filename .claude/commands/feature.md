...
- `docker/app/server/**` - Contains the codebase server.
- `docker/app/client/**` - Contains the codebase client.
...
- `cd docker/app/server && npm run test:run` - Run server tests to validate the feature works with zero regressions
- `cd docker/app/client && npm run test:unit` - Run client tests to validate the feature works with zero regressions
- `cd docker/app/client && npm run test:e2e` - Run end-to-end tests with Playwright if required to validate the feature works with zero regressions
