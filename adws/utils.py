...
def get_worktree_path(branch_name: str) -> str:
    """Get the absolute path to a worktree directory.

    Args:
        branch_name: The branch/worktree name
    ...
    # Construct worktree path: <project_root>/trees/<branch_name>
    worktree_path = os.path.join(project_root, "trees", branch_name)
