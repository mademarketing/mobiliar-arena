...
- [Barrel Distortion](https://docs.phaser.io/phaser/concepts/fx#barrel) : A nice pinch / bulge distortion effect.
- [Bloom](https://docs.phaser.io/phaser/concepts/fx#bloom) : Add bloom to any Game Object, with custom offset, blur strength, steps and color.
- [Blur](https://docs.phaser.io/phaser/concepts/fx#blur) : 3 different levels of gaussian blur (low, medium and high) and custom distance and color.
- [Bokeh](https://docs.phaser.io/phaser/concepts/fx#bokeh) / [Tilt Shift](https://docs.phaser.io/phaser/concepts/fx#tilt-shift) : A bokeh and tiltshift effect, with intensity, contrast and distance settings.
- [Circle Outline](https://docs.phaser.io/phaser/concepts/fx#circle-outline) : Add a circular ring around any Game Object, useful for masking / avatar frames, with custom color, width and background color.
- [Color Matrix](https://docs.phaser.io/phaser/concepts/fx#colormatrix) : Add a ColorMatrix to any Game Object with access to all of its methods, such as `sepia`, `greyscale`, `lsd` and lots more.
- [Glow](https://docs.phaser.io/phaser/concepts/fx#glow) : Add a smooth inner or outer glow, with custom distance, strength and color.
- [Displacement](https://docs.phaser.io/phaser/concepts/fx#displacement) : Use a displacement texture, such as a noise texture, to drastically (or subtly!) alter the appearance of a Game Object.
- [Gradient](https://docs.phaser.io/phaser/concepts/fx#gradient) : Draw a gradient between two colors across any Game Object, with optional 'chunky' mode for classic retro style games.
- [Pixelate](https://docs.phaser.io/phaser/concepts/fx#pixelate) : Make any Game Object appear pixelated, to a varying degree.
- [Shine](https://docs.phaser.io/phaser/concepts/fx#shine) : Run a 'shine' effect across a Game Object, either additively or as part of a reveal.
- [Shadow](https://docs.phaser.io/phaser/concepts/fx#shadow) : Add a drop shadow behind a Game Object, with custom depth and color.
- [Vignette](https://docs.phaser.io/phaser/concepts/fx#vignette) : Apply a vignette around a Game Object, with custom offset position, radius and color.
- [Wipe](https://docs.phaser.io/phaser/concepts/fx#wipe) / [Reveal](https://docs.phaser.io/phaser/concepts/fx#reveal) : Set a Game Object to 'wipe' or 'reveal' with custom line width, direction and axis of the effect.
...
[Events](https://docs.phaser.io/phaser/concepts/events)

[Game](https://docs.phaser.io/phaser/concepts/game)
