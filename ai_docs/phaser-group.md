...
```
  ...
  - `classType` :
    - [Sprite](https://docs.phaser.io/phaser/concepts/gameobjects/sprite) : `Phaser.GameObjects.Sprite`
    - [Image](https://docs.phaser.io/phaser/concepts/gameobjects/image) : `Phaser.GameObjects.Image`
...
- Set [blend mode](https://docs.phaser.io/phaser/concepts/display#blend-mode)
...
- Get first active/inactive game object,
  ...
  - Create one if no game object picked.
    ...
    - Use ( `x`, `y`, `key`, `frame`) to create [Image](https://docs.phaser.io/phaser/concepts/gameobjects/image)/ [Sprite](https://docs.phaser.io/phaser/concepts/gameobjects/sprite) game object.
...
- [Image](https://docs.phaser.io/phaser/concepts/gameobjects/image)
