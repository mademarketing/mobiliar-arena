...
Setup scale mode in [game configuration](https://docs.phaser.io/phaser/concepts/game).
...
- `viewport`: The [Rectangle](https://docs.phaser.io/phaser/concepts/geometry#rectangle) of visible area.
- `camera`: The [camera](https://docs.phaser.io/phaser/concepts/cameras) this viewport is respond upon.
- `out`: The [Rectangle](https://docs.phaser.io/phaser/concepts/geometry#rectangle) of visible area.
