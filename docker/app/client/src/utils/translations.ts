...
const de: TranslationDict = {
  ...
  "infoPanel.giveawayLabel": "Hol Dir dein Give-Away",
  "infoPanel.giveawayThresh": "ab {threshold} Punkten!",
...
const fr: TranslationDict = {
  ...
  "infoPanel.giveawayLabel": "Obtiens ton cadeau",
  "infoPanel.giveawayThresh": "dès {threshold} points!",
