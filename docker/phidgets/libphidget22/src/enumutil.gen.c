...
Phidget_enumFromString(const char *name) {
	...
	if (mos_strcasecmp(name, "MOTOR_DRIVE_TYPE_COAST") == 0)
		return (1);

	if (mos_strcasecmp(name, "MOTOR_DRIVE_TYPE_ACTIVE") == 0)
		return (2);

	if (mos_strcasecmp(name, "MOTOR_POSITION_TYPE_ENCODER") == 0)
		return (1);

	if (mos_strcasecmp(name, "MOTOR_POSITION_TYPE_HALL") == 0)
		return (2);
...
Phidget_enumString(const char *family, int id) {
	...
	if (mos_strcasecmp(family, "MotorDriveType") == 0) {
		switch (id) {
		case 1:
	...
	if (mos_strcasecmp(family, "MotorPositionType") == 0) {
		switch (id) {
		case 1:
...
int
supportedMotorDriveType(PhidgetChannelHandle ch, Phidget_MotorDriveType val) {
...
int
supportedMotorPositionType(PhidgetChannelHandle ch, Phidget_MotorPositionType val) {
