...
int supportedMotorDriveType(PhidgetChannelHandle ch, Phidget_MotorDriveType val);
int supportedMotorPositionType(PhidgetChannelHandle ch, Phidget_MotorPositionType val);
